...
async fn main() {
    ...
    let (tx_input, rx_input) = tokio::sync::mpsc::channel::<core::message::Message>(64);
    let (tx_transformed, mut rx_transformed) =
        tokio::sync::mpsc::channel::<core::message::Message>(64);
    let mut handles = vec![];
